...
class OdometryInterface(Node):
    ...
    def odom_pub_cb(self):
        ...
        base_footprint_trans.transform.translation.x = 0.
        base_footprint_trans.transform.translation.y = 0.
        base_footprint_trans.transform.translation.z = -0.0375
        base_footprint_trans.transform.rotation.x = 0.
        base_footprint_trans.transform.rotation.y = 0.
        base_footprint_trans.transform.rotation.z = 0.
        base_footprint_trans.transform.rotation.w = 1.
        ...
        base_lidar_trans.transform.translation.x = 0.
        base_lidar_trans.transform.translation.y = 0.
...
def main(args=None):
    ...
    homer_odometry = OdometryInterface()

    rclpy.spin(homer_odometry)

    # Destroy the node explicitly
    # (optional - otherwise it will be done automatically
    # when the garbage collector destroys the node object)
    homer_odometry.destroy_node()
    rclpy.shutdown()
